...
let twoMLSPQrs: Target =
	...
	: .binaryTarget(
		name: "TwoMLSPQrs",
		url:
			"https://github.com/germ-network/TwoMLSPQ/releases/download/v0.9.0/TwoMLSPQ.xcframework.zip",
		checksum: "de1db89b8405aaeda8b7b86abebd2de200a3b230daf543e3cfc2935809df16d0"
	)
