...
let twoMLSPQrs: Target =
	...
	: .binaryTarget(
		name: "TwoMLSPQrs",
		url:
			"https://github.com/germ-network/TwoMLSPQ/releases/download/v0.17.0/TwoMLSPQ.xcframework.zip",
		checksum: "e65c20d446bfa5e14d5ef338707a19601d3ab2b6c743432c0d6b7b4711bf6824"
	)
