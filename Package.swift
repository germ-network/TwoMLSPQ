...
let twoMLSPQrs: Target =
	...
	: .binaryTarget(
		name: "TwoMLSPQrs",
		url:
			"https://github.com/germ-network/TwoMLSPQ/releases/download/v0.21.0/TwoMLSPQ.xcframework.zip",
		checksum: "bb8c5507484840ef7cfc6f168981c098e08d66a02411f6b38b078d108a88c180"
	)
