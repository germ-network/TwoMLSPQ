...
let twoMLSPQrs: Target =
	...
	: .binaryTarget(
		name: "TwoMLSPQrs",
		url:
			"https://github.com/germ-network/TwoMLSPQ/releases/download/v0.18.1/TwoMLSPQ.xcframework.zip",
		checksum: "414f2ad2cfbb534fe90afa7b7032a56a6ffb0d976c861601341fe374270d4987"
	)
