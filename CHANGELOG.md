...
- [#13](https://github.com/germ-network/AbstractTwoMLS/pull/13) [`0e13471`](https://github.com/germ-network/AbstractTwoMLS/commit/0e134718209f8a9678ddd6b5a2711e2d0c5911d0) Thanks [@germ-mark](https://github.com/germ-mark)! - Bump TwoMLSPQ to v0.6.0 (contract 20): classical-only establishment return key
